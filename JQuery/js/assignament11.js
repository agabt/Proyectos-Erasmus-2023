$(document).ready(function () {
    ...
    for (let i = 0; i < 4; i++) {
        ...
        $(divHTML).click(function () { 
            let colorOfContainer = $(this).css("background-color");
            addNumberScreen(colorOfContainer);
        });
    };

    let numberClicks = 0;
    let prevColorOfContainer = "";

    function addNumberScreen(currColorOfContainer) {
        if (prevColorOfContainer == currColorOfContainer) {
            numberClicks++;
        };
        
        numberClicksScreen.innerHTML = numberClicks;
        
        prevColorOfContainer = currColorOfContainer;
    }
    ...
    let numberClicksScreen = document.createElement("p");
    let names = [];
    ...
    div.appendChild(numberClicksScreen);
